//===- OR1KAsmPrinter.cpp OR1K LLVM Assembly Printer ------------------===//
//
...
#include "MCTargetDesc/OR1KTargetStreamer.h"
...
MCOperand
OR1KAsmPrinter::LowerSymbolOperand(const MachineOperand &MO,
...
MCOperand OR1KAsmPrinter::lowerOperand(const MachineOperand &MO,
                                         unsigned Offset) const {
...
void OR1KAsmPrinter::lowerToMCInst(const MachineInstr *MI,
                                     MCInst &OutMI) const {
...
extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializeOR1KAsmPrinter() {
  RegisterAsmPrinter<OR1KAsmPrinter> A(getTheOR1KTarget());
}
