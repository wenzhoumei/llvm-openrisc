//===-- OR1KTargetStreamer.cpp - OR1K Target Streamer Methods ---------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file provides OR1K specific target streamer methods.
//
//===----------------------------------------------------------------------===//

#include "OR1KTargetStreamer.h"
...
OR1KTargetStreamer::OR1KTargetStreamer(MCStreamer &S)
    : MCTargetStreamer(S) {}

OR1KTargetAsmStreamer::OR1KTargetAsmStreamer(MCStreamer &S,
                                                 formatted_raw_ostream &OS)
    : OR1KTargetStreamer(S), OS(OS) {}

void OR1KTargetAsmStreamer::emitLiteral(MCSymbol *LblSym, const MCExpr *Value,
...
void OR1KTargetAsmStreamer::emitLiteralPosition() {
  OS << "\t.literal_position\n";
}

void OR1KTargetAsmStreamer::startLiteralSection(MCSection *BaseSection) {
  emitLiteralPosition();
}

OR1KTargetELFStreamer::OR1KTargetELFStreamer(MCStreamer &S)
    : OR1KTargetStreamer(S) {}

void OR1KTargetELFStreamer::emitLiteral(MCSymbol *LblSym, const MCExpr *Value,
                                          bool SwitchLiteralSection, SMLoc L) {
...
void OR1KTargetELFStreamer::startLiteralSection(MCSection *BaseSection) {
...
MCELFStreamer &OR1KTargetELFStreamer::getStreamer() {
