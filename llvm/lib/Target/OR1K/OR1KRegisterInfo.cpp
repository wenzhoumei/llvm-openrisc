//===- OR1KRegisterInfo.cpp - OR1K Register Information ---------------===//
//
...
OR1KRegisterInfo::OR1KRegisterInfo(const OR1KSubtarget &STI)
    : OR1KGenRegisterInfo(OR1K::R0), Subtarget(STI) {}
...
bool OR1KRegisterInfo::eliminateFrameIndex(MachineBasicBlock::iterator II,
  ...
  if (!MI.isDebugValue() && !Valid) {
    ...
    unsigned ADD = OR1K::ADD;
    unsigned Reg;
    const OR1KInstrInfo &TII = *static_cast<const OR1KInstrInfo *>(
