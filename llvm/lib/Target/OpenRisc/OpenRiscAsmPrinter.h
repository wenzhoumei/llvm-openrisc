//===- OpenRiscAsmPrinter.h - OpenRisc LLVM Assembly Printer --------*- C++-*--===//
//
...
//===----------------------------------------------------------------------===//
//
// OpenRisc Assembly printer class.
//
//===----------------------------------------------------------------------===//
...
class LLVM_LIBRARY_VISIBILITY OpenRiscAsmPrinter : public AsmPrinter {
  const MCSubtargetInfo *STI;

public:
  explicit OpenRiscAsmPrinter(TargetMachine &TM,
