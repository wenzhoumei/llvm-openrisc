...
OpenRiscFrameLowering::OpenRiscFrameLowering(const OpenRiscSubtarget &STI)
...
void OpenRiscFrameLowering::emitPrologue(MachineFunction &MF,
...
MachineBasicBlock::iterator OpenRiscFrameLowering::eliminateCallFramePseudoInstr(
    MachineFunction &MF, MachineBasicBlock &MBB,
    MachineBasicBlock::iterator I) const {
  const OpenRiscInstrInfo &TII =
      *static_cast<const OpenRiscInstrInfo *>(MF.getSubtarget().getInstrInfo());
...
void OpenRiscFrameLowering::determineCalleeSaves(MachineFunction &MF,
                                               BitVector &SavedRegs,
