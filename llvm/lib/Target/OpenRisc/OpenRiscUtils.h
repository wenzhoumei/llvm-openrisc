//===--- OpenRiscUtils.h ---- OpenRisc Utility Functions ------------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_OPENRISC_OPENRISCUTILS_H
#define LLVM_LIB_TARGET_OPENRISC_OPENRISCUTILS_H
...
#endif // LLVM_LIB_TARGET_OPENRISC_OPENRISCUTILS_H
